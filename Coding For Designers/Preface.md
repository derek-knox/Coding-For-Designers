...
If you want to jump straight into code, then this book is not for you. We cover many topics before truly diving into actual programming code, though some snippets arise on the journey. Again, the goal of this book is to instill a mental model that helps designers learn coding concepts faster, more deeply, and more intuitively.
