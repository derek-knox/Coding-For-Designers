...
A JavaScript identifier is a keyword with a predetermined-by-JavaScript value. This value is useful to your code as it can help facilitate *language*-specific work. An environment identifier is a keyword with a predetermined-by-the-environment value. Its value is useful to your code too, as it can help facilitate *environment*-specific work. Custom identifiers have the special JavaScript value `undefined` until the identifier is reassigned a value by you or another coder.
