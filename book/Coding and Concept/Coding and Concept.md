...
Second to last, we will look at the *anatomy of a source code file* for HTML (`html.html`), CSS (`.css`), and JavaScript (`.js`). This will allow us to reference real code against various concepts covered thus far. Lastly, we will cover the *work. right. better.* mantra to help you improve your code authoring over time. All coders live by this, myself included.
