      ...
      subs: [
          // img
          {
              ...
              replace: function(match, p1, p2){
                ...
                return '</div><a href="#' + id + '" class="figure-anchor" onclick="return onAnchorJump(this);"><div id="' + id + '" class="content-visual"><figure><img ' + p1 + ' title="' + p2 + '"><figcaption class="hr"><hr><div><span class="figure-anchor-hash">#</span>' + p2 + '</div></figcaption></figure></div></a><div class="content-text">'
              }
          },
          // code block
          {
