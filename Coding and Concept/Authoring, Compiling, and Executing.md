...
The output of this compilation process results in code that the computer *executes* in real-time. This process manifests as an interactive user interface within an application or game.
