...
A server, if you didn't guess already, is also responsible for providing a client web browser the *initial* HTML, CSS, and JavaScript for a website or web app. Now is a great time to venture deeper into coding and we'll do so by exploring the anatomy of each of these three file types.
